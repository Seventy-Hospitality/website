/**
 * Pure pricing/grouping logic for the plan-selection screen (package M1),
 * ported 1:1 from the finished web client (member-web/src/lib/plan-pricing.ts)
 * so the two clients price memberships identically.
 *
